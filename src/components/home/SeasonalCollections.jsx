...
const products = [
  {
    id: 1,
    title: "Geode Resin Clock",
    price: "",
    collection: "Geode Resin Clock",
    image: image3,
  ...
  {
    id: 4,
    title: "Luxury Marble & Gold Dominoes",
    price: "",
    image: image4,
        ...
        >
          {products.map((product) => (
            <motion.div
              ...
              key={product.id}
              className={`group cursor-pointer flex flex-col ${product.className}`}
            >
              ...
              <div className="flex justify-between items-start gap-4 mt-2">
                <div>
                  <h3
                    className={`text-charcoal ${product.large ? "text-xl" : "text-base"}`}
                  >
                    {product.title}
                  </h3>
                  {product.collection && (
                ...
                <p
                  className={`text-charcoal ${product.large ? "text-lg" : "text-sm"} font-light`}
                >
                  {product.price}
                </p>
              </div>
