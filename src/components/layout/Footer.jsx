        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8">
          ...
          <div className="md:col-span-5">
            ...
            <div className="flex gap-4">
              ...
              <a href="https://wa.me/201156909903" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="text-charcoal/60 hover:text-rose-gold transition-colors">
